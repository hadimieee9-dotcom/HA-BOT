...
DEFAULT_CONFIG = {
    "host_usernames": ["Hadixgame3"],
    "admin_usernames": ["Hadixgame3"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
    ...
    "language": "fa",
    "welcome_message": "✨ 🌟 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 {username} ❤️ 𝐆𝐥𝐚𝐝 𝐭𝐨 𝐡𝐚𝐯𝐞 𝐲𝐨𝐮 𝐡𝐞𝐫𝐞!\n🕺 𝐔𝐬𝐞 𝐍𝐮𝐦𝐛𝐞𝐫𝐬 (𝟏-𝟐𝟒𝟖) 𝐨𝐫 𝐄𝐦𝐨𝐭𝐞 𝐍𝐚𝐦𝐞𝐬 𝐭𝐨 𝐝𝐚𝐧𝐜𝐞!\n👑 𝐓𝐡𝐢𝐬 𝐛𝐨𝐭 𝐰𝐚𝐬 𝐜𝐫𝐞𝐚𝐭𝐞𝐝 & 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐝 𝐛𝐲 @HADI.9091 😉\n📺 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 𝐭𝐨 𝐨𝐮𝐫 𝐘𝐨𝐮𝐓𝐮𝐛𝐞: @hadixgame 🚀",
    "announcement_interval": 300,
    "announcement_message": "برای اجاره بات به آیدی @HADI.9091 پیام دهید!"
}
...
class AdvancedBot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str):
        ...
        try:
            ...
            if msg_lower in self.emotes:
                ...
                await self.highrise.chat("👑 سازنده این بات: @HADI9091 👑")
    ...
    async def cmd_help(self, user: User, parts: list):
        help_text = (
            ...
            "📩 برای اطلاعات بیشتر به @HADI9091 پیام بدید!"
        )
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a876a118511df47da50acae")
    api_token = os.getenv("API_TOKEN", "3e63c7f96cf55c897ef8609ef686c4b609e9d3c9a965157eacae11a75dcf316f")
